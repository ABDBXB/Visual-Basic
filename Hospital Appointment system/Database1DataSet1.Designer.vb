...
Namespace Database1DataSet1TableAdapters
    ...
    Partial Public Class doktorTableAdapter
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As Database1DataSet1.doktorDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As Database1DataSet1.doktorDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As Database1DataSet1.doktorDataTable = New Database1DataSet1.doktorDataTable()
